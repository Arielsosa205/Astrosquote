...
After deploy, this URL must return JSON, not a 404:

`https://YOUR-SITE.netlify.app/.netlify/functions/auth-config`

If it returns 404, Netlify did not deploy the `netlify/functions` folder.
